...
### Timeline
- [Apr 2025] 🗞️ VentureBeat: [Beyond generic benchmarks: How Yourbench lets enterprises evaluate AI models against actual data](https://venturebeat.com/ai/beyond-generic-benchmarks-how-yourbench-lets-enterprises-evaluate-ai-models-against-actual-data/)
...
- [Feb 2025] 📜 Arxiv: [SmolLM2: When Smol Goes Big -- Data-Centric Training of a Small Language Model](https://arxiv.org/abs/2502.02737)
- [Jan 2025] 📝 Blog : [CO2 emissions and model performance: Insights from the Open LLM Leaderboard](https://huggingface.co/blog/leaderboard-emissions-analysis)
- [Dec 2024] 📜 Arxiv: [Global MMLU: Understanding and Addressing Cultural and Linguistic Biases in Multilingual Evaluation](https://arxiv.org/abs/2412.03304)
- ✨ [Oct 2024] ⚙️ Release: [Evaluation Guidebook](https://github.com/huggingface/evaluation-guidebook/)
- [Jul 2024] 🗞️ The Economist : [How to tell which AI model is best](https://www.economist.com/science-and-technology/2024/07/31/gpt-claude-llama-how-to-tell-which-ai-model-is-best)
- ✨ [Jul 2024] 🎧 Latent Space: [Benchmarks 201](https://www.latent.space/p/benchmarks-201)
- [Jun 2024] 🗞️ VentureBeat : [Hugging Face’s updated leaderboard shakes up the AI evaluation game](https://venturebeat.com/ai/hugging-faces-updated-leaderboard-shakes-up-the-ai-evaluation-game/)
- [Jun 2024] 🗞️ La Tribune: [Pour contrer la crise de l'évaluation des IA, Hugging Face rehausse les exigences](https://www.latribune.fr/technos-medias/informatique/pour-contrer-la-crise-de-l-evaluation-des-ia-hugging-face-rehausse-les-exigences-1000836.html)
...
- [May 2024] 📝 Blog : [Let's talk about LLM evaluation](https://huggingface.co/blog/clefourrier/llm-evaluation)
- [May 2024] ⭐ Invited to France's top AI talents gathering at Elysée - [Event](https://www.elysee.fr/emmanuel-macron/2024/05/22/rassemblement-des-plus-grands-talents-francais-de-lia)  
- ✨ [May 2024] 📜 ICLR: [GAIA: a benchmark for General AI Assistants](https://openreview.net/forum?id=fibxvahvs3)
- [Apr 2024] 🗞️ La Recherche : [2023, l'année des grands modèles de langue ouverts](https://www.larecherche.fr/intelligence-artificielle/2023-lann%C3%A9e-des-grands-mod%C3%A8les-de-langue-ouverts)
- [Apr 2024] 🗞️ TechCrunch : [Hugging Face releases a benchmark for testing generative AI on health tasks](https://techcrunch.com/2024/04/18/hugging-face-releases-a-benchmark-for-testing-generative-ai-on-health-tasks/)
- [Apr 2024] 📜 Arxiv: [The Hallucinations Leaderboard -- An Open Effort to Measure Hallucinations in Large Language Models](https://arxiv.org/abs/2404.05904)
- ✨ [Feb 2024] ⚙️ Release: [Lighteval](https://github.com/huggingface/lighteval)
...
- [Oct 2023] 📜 Arxiv: [Zephyr: Direct Distillation of LM Alignment](https://arxiv.org/abs/2310.16944)
- [Jun 2023] 📝 Blog : [What's going on with the Open LLM Leaderboard?](https://huggingface.co/blog/open-llm-leaderboard-mmlu)
- [Apr 2023] ⚙️ Release: [Open LLM Leaderboard](https://huggingface.co/open-llm-leaderboard)
- [Mar 2023] 🎧 Parlons Tech : [L'IA générative à la Loupe](https://soundcloud.com/orangehellofuture/parlons-tech-1-ia-generative-ethique-biais-algorithmiques-droits-auteurs)
- [Jan 2023] 📝 Blog : [Introduction to Graph Machine Learning](https://huggingface.co/blog/intro-graphml)
- [Nov 2022] 📜 Arxiv: [Bloom: A 176b-parameter open-access multilingual language model](https://arxiv.org/abs/2211.05100)
- [Oct 2022] 📜 PhD : [Neural Approaches to Historical Word Reconstruction](https://theses.hal.science/tel-04505549/)
- ✨ [May 2022] 📜 ACL: [Probing Multilingual Cognate Prediction Models](https://aclanthology.org/2022.findings-acl.299/)
- [Apr 2022] 📜 Arxiv: [Entities, Dates, and Languages: Zero-Shot on Historical Texts with T0](https://arxiv.org/abs/2204.05211)
- [Aug 2021] 📜 ACL: [Can Cognate Prediction Be Modelled as a Low-Resource Machine Translation Task?](https://aclanthology.org/2021.findings-acl.75/)
- [May 2020] 📜 LREC: [Methodological Aspects of Developing and Managing an Etymological Lexical Resource: Introducing EtymDB-2.0](https://aclanthology.org/2020.lrec-1.392/)
