...
A car allows you to go further, faster than you would on your own two feet, but: 
- it requires some knowledge to be driven properly
- it can make you lazy if you use it all the time for any very short trip
- it encourages you to rush, packing more into your day because you _can_
- it has a ecological and financial cost, compared to walking
...
## Why LLMs are cars
**Driving requires a licence and skills**
For a car, you don't just "get in and go." You need a license, and some skills to navigate. Knowing how to use AI requires you to actually understand risks and limitations, then keep watch and make sure you're going in the correct direction. 
...
Sometimes you want to arrive at answers, sometimes you need to _journey_ through the question.
...
Cars didn't just fill roads; we _rebuilt the cities_ around them (especially in countries like the US). That created suburbs, shopping malls, and the death of the corner store. 
...
Agent APIs are needed for some cases, sure. But highways are terrible places to _stroll_, and you don't always need to use a car. They're designed to get you somewhere quickly, not to let you wander - and can make you lazy, rushed and tired.
