...
- **Développement de site internet**:
    ...
    - EMNLP 2020 - [Site de conférence](https://github.com/acl-org/emnlp-2020-virtual-conference)
    - ACL 2020 - [Site de conférence](https://github.com/acl-org/acl-2020-virtual-conference)

- **Développement logiciel**:
    - Création de [CondALPI](https://gitlab.inria.fr/almanach/alpi/-/tree/condalpi), un installeur perl/conda de la chaîne de TAL ALPI, développé pour la [Task Force EDS-COVID](https://eds.aphp.fr/covid-19) 
